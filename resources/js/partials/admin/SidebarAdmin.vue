<template>
        ...
        <div class="w-64 absolute sm:relative bg-white shadow md:h-full flex-col justify-between hidden sm:flex min-h-screen">
            <div class="px-8">
                ...
                <ul class="mt-12">
                    <li class="flex w-full justify-between text-black hover:text-gray-500 cursor-pointer items-center mb-6">
                        <Link
